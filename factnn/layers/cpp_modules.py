...
sampling_module = tf.load_op_library("/pointnet2/tf_ops/sampling/tf_sampling_so.so")
grouping_module = tf.load_op_library("/pointnet2/tf_ops/grouping/tf_grouping_so.so")
