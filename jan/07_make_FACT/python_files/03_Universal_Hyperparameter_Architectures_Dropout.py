...
#dropout_position = [[False]*9]*9

for i, (model_name, d_pos) in enumerate(zip(model_names, dropout_position)):
    #i = 9
    ...
    number_of_nets = 20
    # Comment on the run
    title_name = 'Compare_diffuse_flat_dropout_architectures_{}'.format(i)
