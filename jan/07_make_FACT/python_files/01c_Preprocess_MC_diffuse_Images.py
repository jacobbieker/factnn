...
def getMetadata(path_folder):
    ...
    if "gamma" in path_folder:
        diffuse_df = read_h5py(path_diffuse, key="events", columns=["event_num", "run_id", "source_position_az",
...
gamma_file_paths, diffuse_df = getMetadata(path_raw_mc_gamma_folder)
