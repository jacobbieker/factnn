...
path_runs_to_use = "/run/media/jacob/SSD/Development/thesis/FACTsourceFinding/runs/Crab.csv"
path_store_mapping_dict = "/run/media/jacob/SSD/Development/thesis/jan/07_make_FACT/rebinned_mapping_dict_4_flipped.p"
#path_mc_images = sys.argv[3]
path_crab_images = "/run/media/jacob/WDRed8Tb2/Rebinned_5_source_crab1314_preprocessed_images.h5"
path_diffuse = "/run/media/jacob/WDRed8Tb1/dl2_theta/precuts/std_analysis/crab_1314_std_analysis_v1.0.0.hdf5"
