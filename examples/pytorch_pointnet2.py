...
if __name__ == '__main__':
    ...
    train_dataset = EventDataset(path, 'trainval', include_proton=True, task="Separation", pre_transform=None,
                                 transform=None)
    test_dataset = EventDataset(path, 'test', include_proton=True, task="Separation", pre_transform=None,
                                transform=None)
    ...
    model = PointNet2_Classifier(num_classes).to(device)
