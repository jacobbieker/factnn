...
path_mc_diffuse_images = "/run/media/jacob/WDRed8Tb2/Rebinned_5_MC_Gamma_TimInfo_Images.h5"
path_to_diffuse = "/run/media/jacob/WDRed8Tb1/dl2_theta/gamma_precuts.hdf5"
